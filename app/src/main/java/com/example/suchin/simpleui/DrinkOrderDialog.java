...
public class DrinkOrderDialog extends DialogFragment {
    ...
    private static final String ARG_PARAM1 = "drinkOrder";
    // UI Component
...
//            drinkOrder.newInstanceWithJsonObjectData(data);
//        }
//    }
...
//    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (getArguments() != null) {
            String data = getArguments().getString(ARG_PARAM1);
            drinkOrder = DrinkOrder.newInstanceWithJsonObjectData(data);
        }
